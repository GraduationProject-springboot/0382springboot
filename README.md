...
# 0382springboot西安旅游系统--论文pf

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T1bpekEK7?p=54)
...
本课题研究和开发西安旅游系统管理系统，让安装在计算机上的该系统变成管理人员的小帮手，提高西安旅游系统信息处理速度，规范西安旅游系统信息处理流程，让管理人员的产出效益更高。
## 1.2 课题意义
传统处理数据，必须是一张张纸，然后处理完毕又是统计在一张张纸上面，不断的重复处理，最终有个结果给最高层作为参考，这个模式在互联网没有出现之前，是一种常见的事情，信息管理的效率提不上去，人多不一定力量大，因为人多肯定更加消耗资源，并且因为人类需要休息，需要管理，思想会不统一，会偷懒，所以人们研究出专门帮助人们计算的机器，就是计算机的前身，到了互联网时代，人们发现完全可以让程序供应商提供解决方案，自己挑选自己合适的方案来提高自己的产出比。所以在日常工作和生活中会发现各种各样方便人们的工具。

本课题研发的西安旅游系统管理系统，就是提供西安旅游系统信息处理的解决方案，它可以短时间处理完信息，并且这些信息都有专门的存储设备，而且数据的备份和迁移都可以设定为无人值守，从人力角度和信息处理角度以及信息安全角度，西安旅游系统管理系统是完胜传统纸质操作的。
## 1.3 研究内容
本文对西安旅游系统管理系统的设计与实现分成六个章节来说明。

第1章：研究西安旅游系统管理系统的背景，以及开发西安旅游系统管理系统的意义。

第2章：对开发西安旅游系统管理系统的环境还有技术进行说明。

第3章：分析西安旅游系统管理系统的可行性，性能，流程以及功能。

第4章：设计西安旅游系统管理系统的功能结构，设计数据库E-R图以及对数据表的存储结构进行设计。

第5章：实现西安旅游系统管理系统的功能并进行功能界面展示。

第6章：对系统测试进行阐述，以及对本系统部分功能进行检测。
# 第2章 开发环境与技术
本章节对开发西安旅游系统管理系统需要搭建的开发环境，还有西安旅游系统管理系统开发中使用的编程技术等进行阐述。
## 2.1 Java语言  
...
图3.1 系统操作流程
### 3.2.2 登录流程
西安旅游系统管理系统通过登录功能（图3.2即为其登录的流程）引导使用者进入指定的功能操作区，也避免非本系统的用户享受本系统提供的服务以及查看本系统提供的信息，进而保证用户安全。

![](/md/blog.002.png)

图3.2 登录流程
### 3.2.3 删除信息流程
西安旅游系统管理系统在经过长期使用后，会产生很多的数据信息。为了腾出存储空间存放更多的数据，本系统数据库中存储的数据，一些没有参考价值的数据需要进行删除（图3.3即为删除信息的流程），删除数据过程中，为避免误删，使用者要根据系统的提示来决定是否删除数据。

![](/md/blog.003.png)

图3.3 删除信息流程
### 3.2.4 添加信息流程
西安旅游系统管理系统提供可视化的功能操作区，非常方便使用者进行数据操作，当使用者往系统中录入数据时（图3.4即为添加信息的流程），本系统也会进行数据合法性的判断，符合要求的数据才能够在数据库指定表中进行登记。
...
## 3.4 功能需求
西安旅游系统管理系统根据使用权限的角度进行功能分析，并运用用例图来展示各个权限需要操作的功能。
# 第4章 系统设计
...
## 4.2 功能结构设计
图4.1即为设计的管理员功能结构，管理员权限操作的功能包括管理新闻资讯，管理西安旅游系统信息，包括景点管理，培训管理，旅游攻略管理，薪资管理等，可以管理新闻资讯。

![结构设计图](/md/blog.005.jpeg "结构设计图")

图4.1 管理员功能结构
## 4.3 数据库设计
西安旅游系统管理系统运行中产生的数据需要按照提前设置的存储规则进行保存，设计出一个符合项目的最优数据存储格式，因为它能减少用户的等待时间，还可以对系统的请求在最短时间内进行响应。所以，对数据库设计时，需要对功能需求进行详细的拆分，以及对业务状态的细分，然后设计具体的存储规则，保证数据库能正常运作，缩短数据处理时间，并在一定程度上降低数据冗余，节省存储空间。
### 4.3.1 数据库概念设计
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\旅游攻略.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\旅游攻略.jpg")
旅游攻略实体属性图
...
（4）下图是旅游景点收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\旅游景点收藏.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\旅游景点收藏.jpg")
旅游景点收藏实体属性图

（5）下图是景点实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\景点.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\景点.jpg")
景点实体属性图

（6）下图是景点留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\景点留言.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\景点留言.jpg")
景点留言实体属性图

（7）下图是新闻资讯实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\新闻资讯.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\新闻资讯.jpg")
新闻资讯实体属性图

（8）下图是预订实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\预订.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\预订.jpg")
预订实体属性图

（9）下图是旅游攻略收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\旅游攻略收藏.jpg](/md/blog.014.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\旅游攻略收藏.jpg")
旅游攻略收藏实体属性图
### 4.3.2 数据库物理设计
...
|3|gonglue\_name|String|攻略名称|是|
|4|gonglue\_uuid\_number|String|攻略编号|是|
|5|gonglue\_photo|String|攻略照片|是|
|6|gonglue\_chu\_address|String|出发地点|是|
|7|gonglue\_mu\_address|String|目的地点|是|
|8|zan\_number|Integer|赞|是|
|9|cai\_number|Integer|踩|是|
|10|gonglue\_content|String|历史介绍|是|
|11|gonglue\_xiandai\_content|String|现代简介|是|
|12|gonglue\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|gonglue\_id|Integer|旅游攻略|是|
|3|yonghu\_id|Integer|用户|是|
|4|gonglue\_collection\_types|Integer|类型|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|gonglue\_order\_uuid\_number|String|订单编号|是|
|3|gonglue\_id|Integer|攻略|是|
|4|yonghu\_id|Integer|用户|是|
|5|gonglue\_order\_time|Date|预约时间|是|
|6|gonglue\_order\_types|Integer|订单类型|是|
...
|8|jingdian\_content|String|历史介绍|是|
|9|jingdian\_xiandai\_content|String|现代简介|是|
